...
({
    ...
    return (
        <Container>
            ...
            <div>
                <Typography className={classes.subSectionTitle}>Set your Transportation budget goal</Typography>
            </div>
            <div className={classes.goalHeader}>
                <Typography className={classes.goalTitle}>{categories[6]}</Typography>
                <Typography className={classes.totalPreview}>Actual: ${values[6]}</Typography>
            </div>
